...
directories=("components" "pages" "app" "api" "styles" "utils" "hooks" "constants" "services" "types" "src" "resources" "main" "preload" "renderer" "public"
 "lib" "branding" "customui" "ui" "(pages)" "content" "localization" "languages" "types" "legal" "sites" "cookies" "privacy" "terms" "prisma")

# List of file types to ignore
ignore_files=("*.ico" "*.png" "*.jpg" "*.jpeg" "*.gif" "*.svg" "*.woff2")
